...
final class SchemaConverter {
    ...
    enum ConversionError: Error, CustomStringConvertible {
        ...
        var description: String {
            ...
            case .missingProperties:
                return "Missing properties in object schema"
    ...
    private func convertProperty(name: String, property: JSONSchemaProperty) throws -> DynamicGenerationSchema {
        ...
        case "array":
            guard let items = property.items,
                  let itemProperty = items.toJSONSchemaProperty() else {
